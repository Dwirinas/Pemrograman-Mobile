...
public class ListHmjAdapter extends RecyclerView.Adapter<ListHmjAdapter.ListViewHolder>{
    ...
    public ListHmjAdapter(ArrayList<Hmj>list){ this.listHmj=list;
    }

    @NonNull
    @Override
    public ListHmjAdapter.ListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
