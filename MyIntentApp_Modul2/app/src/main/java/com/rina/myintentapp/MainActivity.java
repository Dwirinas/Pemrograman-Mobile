...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button btnDial;
    Button btnLinkPolines , btnIntent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLinkPolines = findViewById(R.id.btn_link_polines);
        btnLinkPolines.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_move_data:
                ...
                moveData.putExtra(MoveActivityWithData.EXTRA_NAME, " Dwi Rina");
                moveData.putExtra(MoveActivityWithData.EXTRA_AGE,  19);
                startActivity(moveData);
                break;
            case R.id.btn_dial:
                String phoneNumber  = "08995469572";
                Intent dialPhone = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" +phoneNumber));
                startActivity(dialPhone);
                break;
            case R.id.btn_link_polines:
                Intent LinkPolines = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.polines.ac.id"));
                startActivity(LinkPolines);
                break;
            case R.id.btn_act2:
